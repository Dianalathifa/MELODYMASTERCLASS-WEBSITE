...
function AdminPage() {
    ...
    const GetDataAdmin = async () => {
        ...
        setDataAdmin(getData.data.data);
        console.log(getData);
                            ...
                            <CCard className="mb-4">
                                ...
                                <CCardBody>
                                    <p className="text-medium-emphasis small">
                                        Tabel ini menampilkan seluruh data admin
                                    </p>
                                    <div className="py-3">
                                        <CButton className="btn btn-success text-white me-2" href="RegisterAdmin">
                                            Tambah Data
                                        </CButton>
                                    </div>
                                    <CTable striped>
                                            ...
                                            {data_admin.map((admin, index) => (
                                                <CTableRow key={index}>
                                                    ...
                                                    <CTableDataCell>
                                                        ...
                                                        <CButton className='btn btn-danger text-white' onClick={() => showModalDelete(admin)}>Hapus</CButton>
                                                    </CTableDataCell>
                                                </CTableRow>
                                            ))}
                                        </CTableBody>
